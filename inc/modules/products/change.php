...
$template->set_ar('allergens', $pdb->allergens_for($id));
$template->set_ar('product_groups', $pdb->product_groups_for($id));
$template->set_ar('labels', $pdb->labels_for($id));
$template->set_ar('producers', $pdb->producers());
$template->set_ar('customer_groups', $pdb->customer_groups_for($id));
$template->set_ar('suppliers', $pdb->suppliers_for($id));
$template->set_ar('available_suppliers', $pdb->suppliers_not($id));
$template->out($design);
